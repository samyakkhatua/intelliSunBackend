...
async def predict(input_data: InputData):
    ...
    # Extract the predicted values and add them to the results list
    orientation, position, current = predicted_values[0]

    print(orientation,position, current)
    results.append({'Panel_Orientation': orientation, 'Panel_Position': position, 'Current_Generated': current})
